...
namespace System.Management
{
    ...
    internal static class WmiNetUtilsHelper
    {
        ...
        static WmiNetUtilsHelper()
        {
            ...
            string netFrameworkInstallRoot = (string)netFrameworkSubKey?.GetValue("XXXInstallRoot");
            ...
            string wminet_utilsPath = Path.Combine(
                ...
                $"v4.0.30319", // The same value is hard coded on Environment.Version for .NET Framework
                "wminet_utils.dll");
        ...
        internal int ConnectNSecureIWbemServices(string path, ref IWbemServices pServices)
        {
            ...
            if (null != scope)
            {
                ...
                try
                {
                    ...
                    {
                        WmiNetUtilsHelper.SetSecurity_f.Invoke(ref needToReset, ref handle);
                    }
